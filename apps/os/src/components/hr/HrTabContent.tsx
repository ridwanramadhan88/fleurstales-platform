  ...
  return <PeoplePageShell>
    ...
    >
      ...
      {canCreateAccounts ? <section className="space-y-5 rounded-xl bg-card p-4 ring-1 ring-border/70">
        <div className="space-y-1"><h3 className="text-sm font-semibold leading-5">Login access</h3><p className="text-sm leading-5 text-muted-foreground">Create the staff username and six-digit PIN. Supabase keeps the underlying Auth email private.</p></div>
