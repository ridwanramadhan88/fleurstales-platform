  ...
  "fixed z-50 gap-4 border-border/60 bg-surface-card shadow-ios-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-400 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
        ...
        bottom: "mobile-sheet-safe inset-x-0 bottom-0 rounded-t-2xl border-t p-5 data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom sm:p-6",
        ...
        responsiveRight: "mobile-sheet-safe inset-x-0 bottom-0 rounded-t-2xl border-t p-5 data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom sm:p-5 md:inset-y-0 md:left-auto md:right-0 md:bottom-auto md:h-full md:max-h-dvh md:max-w-none md:rounded-none md:border-l md:border-t-0 md:p-6 md:data-[state=closed]:slide-out-to-right md:data-[state=open]:slide-in-from-right",
      },
    },
    defaultVariants: {
      side: "right",
