  ...
  ({ activeKey, edge = 'page', className, children, ...props }, forwardedRef) => {
    ...
    return (
      <div
        ref={setRef}
        className={cn(
          'no-scrollbar flex min-w-0 flex-nowrap items-center gap-2 overflow-x-auto py-1 overscroll-x-contain md:flex-wrap md:overflow-visible md:overscroll-auto',
          CHIP_ROW_EDGE[edge],
          className,
        )}
        {...props}
