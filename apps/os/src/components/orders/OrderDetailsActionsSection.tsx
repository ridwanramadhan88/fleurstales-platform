...
export const OrderDetailsActionsSection: FC<OrderDetailsActionsSectionProps> = ({ viewModel }) => {
  ...
  return (
    <>
      <section className="safe-area-bottom z-20 isolate -mx-5 -mb-4 flex shrink-0 items-center justify-between gap-2 border-t border-border/55 bg-surface-footer px-5 pt-3 pb-3 shadow-[0_-8px_18px_-18px_rgba(0,0,0,0.45)] sm:-mx-6 sm:-mb-5 sm:rounded-b-2xl sm:px-6 sm:pb-3.5 sm:pt-3.5">
