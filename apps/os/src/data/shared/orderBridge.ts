...
const orderStatePayload = (order: OrderTableRow): Json => ({
  ...
  finish_photo_url: order.finishPhotoUrl ?? null,
  finish_photo_uploaded_by: order.finishPhotoUploadedBy ?? null,
  finish_photo_uploaded_at: order.finishPhotoUploadedAt ?? null,
