...
const mapOrder = (row: OrderWithItemsRow): SharedOrder => ({
  ...
  finishPhotoUrl: optional(row.finish_photo_url),
  finishPhotoUploadedBy: optional(row.finish_photo_uploaded_by),
  finishPhotoUploadedAt: optional(row.finish_photo_uploaded_at),
  paymentProofUrl: optional(row.payment_proof_url),
