...
export const CartDrawer: FC<CartDrawerViewModel> = (viewModel) => {
  ...
  return (
    <div className="storefront-modal-layer fixed inset-0 z-[100] flex items-end justify-center bg-black/40 sm:items-stretch sm:justify-end" onClick={handleClose} role="presentation">
      <section onClick={(event) => event.stopPropagation()} className="storefront-checkout-sheet storefront-checkout-sheet--enter relative flex h-[92svh] w-full max-w-[520px] flex-col bg-[var(--sf-cream)] text-black shadow-[-14px_0_42px_rgba(0,0,0,0.16)] sm:h-full sm:max-h-none lg:max-w-[590px] xl:max-w-[600px]" role="dialog" aria-modal="true" aria-labelledby="storefront-checkout-title">
