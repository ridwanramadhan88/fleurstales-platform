...
describe('natural Indonesian UI copy', () => {
  ...
  it('covers the pre-release catalog and order copy audit', () => {
    ...
    expect(translateUiText('No products match this collection. Try a different category or type.', 'id')).toBe('Tidak ada produk yang cocok dengan koleksi ini. Coba kategori atau jenis lain.')
